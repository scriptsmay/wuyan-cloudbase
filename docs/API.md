...
```json
{
  "code": 200,
  "data": {
    "lines": ["每一天的坚持，都是通往冠军的路 💙", "无言加油，我们永远是你的后盾"],
...
```json
{
  ...
  "data": {
    ...
    "emoji_caption": "陪伴是最长情的告白 💙",
    "report_id": "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
    "refs": [{ "label": "当前赛季 KDA", "value": "3.8", "source": "season_summaries" }],
    "source_snapshot_at": "2026-07-13T04:00:00.000Z"
  }
}
```
...
| 2026-07-20 | 新增 `GET /api/checkins/me/report` 接口                                                          |
| 2026-07-21 | 登录简化为 CloudBase `signOut + signInWithPassword`；匿名与正式 UID 独立，移除自定义认证迁移 API |
