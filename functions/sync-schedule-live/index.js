...
exports.main = async (event, context) => {
  ...
  try {
    // 1. 读取最新赛季文档
    const existing = await db.collection('match_schedules')
    ...
    console.log(`[sync-schedule-live] Match window active (${windowStatus.active_count} matches), fetching KPL schedule...`)
